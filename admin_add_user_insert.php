...
if(isset($_POST['NUsubmitBtn']))
{
    ...
    if (!mysqli_query($con, $sql)){
        ...
        echo "<script>alert('Successful!'); window.location.href='admin_view.php';</script>";
    }

    mysqli_close($con);
}
else{
    echo "<script>alert('Please fill in the form'); window.location.href='admin_add_user.php';</script>";
}
?>