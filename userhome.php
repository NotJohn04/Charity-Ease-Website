...
/*
    ...
    $sql = "SELECT * FROM userdetail WHERE user_id = " . $_SESSION["user_id"] . "";
    ...
    if ($row['user_type'] !='member')
        ...
        echo "Hello ".$row["account_name"]."!<br>";
        echo '<br>Session value: '.$_SESSION["user_id"].'<br>';
        $_SESSION["fullname"] = $row["account_name"];

        if (isset($_COOKIE['user_login'])){
            echo '<br>Cookie value: '.$_COOKIE['user_login'].'<br>';
        }
    }
*/
...
?>
    ...
    <div class="header3">
        ...
        <div class="description">
            ...
            <button id="Lmh" onclick="window.location.href='donation.php'">Let me Help!</button>
        </div>
