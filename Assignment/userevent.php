...
<body>
    ...
    <div class="box1">
        ...
        <div class="box3">
        <button class="profilebtn" onclick="window.location.href='profile.php'" >Profile</button>
    ...
    <div class="header3">
        ...
        <div class="description">
            ...
            <div class="des-content">
                ...
                <div class="row">
                <button id="Lmh" onclick="window.location.href='feedback.php'">
                    Feedback
                </button>
                <button id="Lmh" onclick="window.location.href='comments.php'">
                    Comments
                </button>
                </div>
